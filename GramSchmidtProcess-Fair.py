...
def dimensions(A):
#     print(gsBasis(A))
#     print(la.norm(gsBasis(A), axis=0))
...
dimensions(B)
# print('----')
# print(la.norm([0.93704257, 0.31234752, 0.15617376]))
# a = [ 0.94573249, -0.26786082, -0.06951101]
# sum_val = a[0]**2 + a[1]**2 + a[2]**2
# print('sum is:', sum_val)
# square_root = math.sqrt(sum_val)
# print('ans:', square_root)
